...
const Home = () => {
  ...
  const handlerNextButton = async () => {
    if (tripName?.length > 0) {
      ...
      await AsyncStorage.setItem("tripName", JSON.stringify(tripName));
      await AsyncStorage.setItem("tripMembers", JSON.stringify(members));
    }
  };
      ...
      <ScrollView style={{ flex: 1, paddingHorizontal: 4 }}>
        ...
        >
          <View style={[styles.card, { marginTop: 20 }]}>
            ...
            >
              Welcome to Trip Cost Calculator
            </Text>
            ...
            >
              ...
              <TextInput
                ...
                placeholder="Ex: Saintmartin Trip"
                value={tripName}
        ...
        <TouchableOpacity onPress={openPlayStore} style={styles.bottomRight}>
          <Text style={[styles.text, { color: "#676767", marginBottom: 6 }]}>
            Powered by{" "}
            <Text style={[styles.text, { color: "#5066B0" }]}>
